CREATE PROCEDURE [dba_sp_running_job_check]
AS
...
--Place the query below into a SQL Server Agent job, and it will send an email with an attachment containing the output from the stored procedure.
...
EXEC msdb.dbo.sp_send_dbmail
	@profile_name = 'AMG-WAL-SQL08', --Check Profile Name in Database Mail configuration
	@recipients = 'stephen.mccord@amg.com; steven.brusstar@managersinvest.com',
	@query = 'EXEC [dba_sp_running_job_check]' ,
